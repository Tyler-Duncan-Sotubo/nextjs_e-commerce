  ...
  return (
    <div>
      {scrollPosition > 20 ? null : (
        <nav className="flex justify-between px-14 py-3 font-display text-[14px] text-gray-600 bg-white border-b-[1px]">
          <div className="flex gap-3 ">
            ...
            <div>
              Order Online
              <span className="font-semibold underline">Call(0123) 456789</span>
            </div>
          </div>
